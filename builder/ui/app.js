...
const LINKEDIN_COMMENTS = [
  "This is just the first section of my newsletter - there are two more quick topics if you're interested. Sign up at https://mattberan.com or on Substack (https://mattberan.substack.com/). No spam, no account, just a literal email sent by me.",
  "Heads up - this is only The Take from my newsletter. Two more topics inside if you want them. Sign up at https://mattberan.com or on Substack (https://mattberan.substack.com/). No spam, no account, just a literal email sent by me.",
  "There are two more quick topics in the full newsletter if this caught your attention. Sign up at https://mattberan.com or on Substack - https://mattberan.substack.com/ - no spam, no account, just a literal email. Sent by me.",
  "Quick note - this is just one of three topics from this week's newsletter. Two more inside. Sign up at https://mattberan.com or on Substack (https://mattberan.substack.com/). No spam, no account, just a real email from me.",
  "This is only The Take - there are two more quick sections in the full newsletter. Sign up at https://mattberan.com or on Substack (https://mattberan.substack.com/) if you're interested. No spam, no account, just a literal email sent by me.",
];
...
function renderSubstackPreview(payload) {
  ...
  function itemBlock(item) {
    ...
    if (item.has_deep && item.deep_content) {
      parts.push(item.deep_content.trim());
    } else {
      parts.push(item.sentence);
      if (item.external_link) parts.push(item.external_link);
    }
    return parts.join('\n\n');
  }
